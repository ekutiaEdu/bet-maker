...
async def test_create_bet_endpoint(empty_db, client, app):
    response = await client.post(
        url=app.url_path_for("bets:add"),
...
@pytest.mark.asyncio(loop_scope="module")
async def test_get_all_endpoint(filled_db, client, app):
    response = await client.get(url=app.url_path_for("bets:get_all"))
